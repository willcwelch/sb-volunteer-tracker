...
class OrganizationsController extends AppController
{
    ...
    public function view($id = null)
    {
        $organization = $this->Organizations->get($id, [
            'contain' => ['Affiliations', 'Users', 'Projects']
        ]);
    ...
    public function add()
    {
        ...
        $affiliations = $this->Organizations->Affiliations->find('list', ['limit' => 200]);
        $users = $this->Organizations->Users->find('list', ['limit' => 200]);
        $this->set(compact('organization', 'affiliations', 'users'));
        $this->set('_serialize', ['organization']);
    }
